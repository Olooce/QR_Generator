...
std::vector<int> encodeData(const std::string& data) {
    ...
    // Step 2: Add character count indicator (16-bit for versions 40 and above in byte mode)
    ...
    int terminatorLength = std::min(4, 2956 - static_cast<int>(dataBits.size()));
